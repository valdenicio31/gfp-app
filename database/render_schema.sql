...
create index if not exists launches_user_date_idx on launches(user_id,launch_date desc);
create index if not exists planning_records_user_module_idx on planning_records(user_id,module);
